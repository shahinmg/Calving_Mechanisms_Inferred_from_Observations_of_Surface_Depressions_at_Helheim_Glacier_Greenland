...
op = '/media/laserglaciers/upernavik/atlas_south_copc/figs/flexure_vs_non_flexure/behind_calving_block/flexure/individual_calving/'
...
df_all.rename(columns={0:'days_around_calving'},inplace=True)
df_all['days'] = df_all['days_around_calving'].dt.days
df_all.to_pickle(f'{pkl_vel_out}vel_flexure_style_calving.pkl')
